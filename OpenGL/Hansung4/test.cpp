...
int main()
{
	...
	glBufferData(GL_ARRAY_BUFFER, nSphereVert * nSphereAttr * sizeof(float), sphereVerts, GL_STATIC_DRAW); //그리라는 뜻인가?
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		starShader.setVec3("material.emission", 0.5f, 0.5f, 0.5f);
